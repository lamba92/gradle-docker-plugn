...
class RegistriesContainer(
    ...
    fun dockerHub(username: String, password: String) {
    ...
    fun amazonEcr(accountId: String, region: String, token: String) {
    ...
    fun githubContainerRegistry(username: String, token: String) {
    ...
    fun googleArtifactRegistry(projectId: String, location: String, repositoryId: String, token: String) {

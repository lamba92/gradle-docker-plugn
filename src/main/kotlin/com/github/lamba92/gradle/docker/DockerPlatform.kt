...
import com.github.lamba92.gradle.docker.DockerPlatform.values
...
enum class DockerPlatform(val commandLineValue: String) {
    ...
    companion object {
        fun fromCommandLineValue(value: String): DockerPlatform? = values().find { it.commandLineValue == value }

        fun defaults() = listOf(LINUX_AMD64, LINUX_ARM64)
    }
}
